        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etName.length() == 0 || etPwd.length() == 0 || etIdcard.length() == 0 || etPhone.length() == 0
                        || etAddress.length() == 0) {
                    Toast.makeText(AddUserActivity.this, "请填写完整注册信息", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (departId == -1) {
                    Toast.makeText(AddUserActivity.this, "下拉条获取出错", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            int responseCode = response.getInt("stateCode");
                            if(responseCode == 404) {
                                Toast.makeText(AddUserActivity.this, "获取部门列表失败", Toast.LENGTH_SHORT).show();
                                return;
                            }else if(responseCode == 500) {
                                ...
                                //适配器
                                arr_adapter= new ArrayAdapter<>(AddUserActivity.this, android.R.layout.simple_spinner_item, data);
                                //设置样式
